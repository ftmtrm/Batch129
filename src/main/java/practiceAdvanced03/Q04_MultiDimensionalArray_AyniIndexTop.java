...
public class Q04_MultiDimensionalArray_AyniIndexTop {
    public static void main(String[] args) {
        ...
        for (int i = 0; i <arr1.length ; i++) {//outer loop
                limit = arr1[i].length;
            if (limit > arr2[i].length) {
                limit = arr2[i].length;//yeni limit bu oldu
            }
            for (int j = 0; j < limit; j++) {//inner loop
