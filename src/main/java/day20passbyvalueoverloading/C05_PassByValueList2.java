...
public class C05_PassByValueList2 {
    public static void main(String[] args) {
       /* bir list oluşturalım.
        ...
        // listin ve arrayin YAPISINI degistirirsek atama yaparsakdeger de degisir.
        // Ornegin "harfler = listDegistir(harfler);" yapinca degisir

        harfler = listDegistir(harfler);
        System.out.println("mainin icinde methoddan sonra harfler = " + harfler);//[]
    }
