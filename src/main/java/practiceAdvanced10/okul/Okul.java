...
public class Okul {//pojo class her bir ogrenci objesi data type'dir.
    // her class bir data type ama her data type class degildir

    private String okulAdi;
    private int maxOgrenciSayisi;
    private List <Ogrenci>ogrenciListesi = new ArrayList();//data tipi ogrenci
