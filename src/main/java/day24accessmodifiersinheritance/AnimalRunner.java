...
public class AnimalRunner {
 ...
 Java'da parent'i olmayan tek Class Object Class dir.
    ...
    public static void main(String[] args) {
        ...
        maymus.eat();
        // breath'i default yapinca maymus.breath calismiyor!!!cunku package farkli
        //child method protected olsa da goruyor.//eat'i Animal'daki eat'i protected yaptik

        //babalar cocuklarinin birseyini kullanamaz
        //meow,bark,tweet'i kullanamaz.
