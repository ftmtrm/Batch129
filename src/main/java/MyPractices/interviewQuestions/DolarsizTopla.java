...
public class DolarsizTopla {
   /* getSum isminde bir method oluşturun.Parametresi ArrayList'tir.
    Dizideki tüm $ ları kaldır ve tüm sayıları topla
   return yaptğımız veri tipi 'int' olmalıdır.sonuç 0'dan küçükse, -1 yazdırın.

    ArrayList = $13, $15, $20  Cevap = 48 olmalı
    ArrayList= $-13, $0, $0
            Cevap = -1 olmalı.*/
    ...
    private static int getSum(ArrayList<String> arrlist) {
        ...
        for (String  each : arrlist) {
            ...
            toplam +=Integer.valueOf(str);//Integer.parseInt(str); //string olan sayi degerlerini integer a cevirdik ve toplama ekledik
        }
        if(toplam<0){
