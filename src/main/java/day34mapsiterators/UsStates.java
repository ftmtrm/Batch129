...
public enum UsStates {
    /* Enum bir sabit, degisme ihtimali olmayan data deposudur.(yilin aylari, haftanin gunleri,ABD'nin eyaletleri)
    Sabit datalari application'lara gommek icin kullanilir.Application kendi basina ayakta durabilmesi(standalone) icin
    sabit datalari app'in icine gomeriz.
     */
