...
public class Lists04 {
    ...
    boolean r = names.containsAll(females);//hepsi olmadan true vermez sadece Ajda var o nedenle false olur.
    ...
    List<String> homeGoods = new ArrayList<>();
        ...
        //"isEmpty()" esasinda "names.size()==0" demektir.//2.de 2 is var javanin yaptigi
        names.isEmpty();

        System.out.println(names.hashCode());// 2041509 javanin urettigi adresi size verir.hashing technique

        List<String> isimler = List.of("Ali, Veli, Can, Kemal");
