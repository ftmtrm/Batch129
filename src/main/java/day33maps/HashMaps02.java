...
public class HashMaps02 {
    public static void main(String[] args) {
        //Ex: Size verilen bir cumledeki herbir kelimenin kacar kere kullanildigini gosteren kodu yaziniz.
        ...
        sentence = sentence.replaceAll("\\p{Punct}","");//stringler immutable o nedenle atama yapmaliyiz
