...
public class KullaniciBilgileriMap {
    ...
    */
            ...
            do {
                ...
                input.nextLine();//ustuste println kullanildigi zaman ya da donguden dolayi bug olusuyor.(Javanin bug'i)
                //Konsolda "Devam etmek istiyormusunuz E/H"cevabini yazamadan direkt
               // "Bilgilerini gormek istediginiz kisinin TC numarasini giriniz" yazdiriyor.bu nedenle
                // dummy atildi dongunun devam edebilmesi, satir atlamamasi icin.
